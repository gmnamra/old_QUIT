...
DESPOT_DIR  := DESPOT
DESPOT_SRC  := SignalEquations Sequence DESPOT_Functors
DESPOT_HDR  := $(addprefix $(SOURCE_DIR)/$(DESPOT_DIR)/, SignalEquations.h Sequence.h DESPOT_Functors.h RegionContraction.h)
