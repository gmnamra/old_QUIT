...
namespace Agilent {
	...
	class Parameter {
		...
		protected:
			...
			std::vector<std::string> m_strings, m_stringAllowed;
			Eigen::ArrayXd m_reals, m_realAllowed;
		...
		public:
			...
			const Eigen::ArrayXd &reals() const;
	...
	class ProcPar {
		...
		public:
			...
			const std::vector<double> reals(const std::string &name) const;
